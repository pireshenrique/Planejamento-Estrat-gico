...
import { INVESTIMENTOS_EVIDENCES } from '../../../data/evidences/investimentos';
...
export function InvestimentosView({ setActivePage }: InvestimentosViewProps) {
    ...
    <div className="w-full flex flex-col gap-6 font-sans text-slate-800 dark:text-slate-200 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col xl:flex-row gap-6 mb-2">
        <div className="flex items-start gap-4 w-full xl:w-1/2 2xl:w-5/12 shrink-0">
          ...
          <div>
            <h1 className="text-[30px] md:text-[34px] font-bold text-slate-900 dark:text-white tracking-tight mb-1 leading-tight">PIB Investimentos (FBCF)</h1>
            <p className="text-[17px] text-slate-600 dark:text-slate-400 ">
              Análise da Formação Bruta de Capital Fixo e da expansão da capacidade produtiva nacional.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full flex-1">
          <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-start gap-3 h-full">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-baseline gap-2">
                <h3 className="text-[26px] 2xl:text-[28px] font-black text-indigo-600 dark:text-indigo-400 leading-none">0,6%</h3>
              </div>
          ...
          <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-start gap-3 h-full">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-baseline gap-2">
                <h3 className="text-[26px] 2xl:text-[28px] font-black text-indigo-600 dark:text-indigo-400 leading-none">3,5%</h3>
              </div>
          ...
          <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-start gap-3 h-full">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-baseline gap-2">
                <h3 className="text-[26px] 2xl:text-[28px] font-black text-indigo-600 dark:text-indigo-400 leading-none">3,1%</h3>
              </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-[26px] md:text-[30px] font-extrabold text-slate-900 dark:text-white leading-tight">Taxa de juros inibe novos aportes, e mercado adota postura de <span className="text-indigo-600 dark:text-indigo-400">cautela máxima</span>.</h2>
        </div>
        ...
        <div className="mb-0">
          ...
          <div className="relative bg-white dark:bg-[#111827] rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
            ...
            <div className="flex flex-col gap-6 relative z-10">
                ...
                <div className="pt-1">
                  ...
                  <div className="inline-flex bg-slate-50/80 dark:bg-slate-900/30 px-3 py-1.5 rounded-lg mt-1">
                    <span className="text-[13px] text-slate-700 dark:text-slate-400 font-semibold">
                      Avanço tímido focado em renovação obrigatória e construção civil leve.
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 text-[14px] text-slate-600 dark:text-slate-400 leading-relaxed md:pl-[64px]">
                <p>
                A Formação Bruta de Capital Fixo (FBCF) registrou um avanço de 3,5% no 1º trimestre de 2026, sinalizando um descolamento pontual após seguidos semestres de retrações acumuladas. Embora encorajador do ponto de vista conjuntural, o movimento ainda é analisado como frágil e insuficiente para anular o déficit de expansão de capacidade vivenciado nos últimos dois anos e não reflete retomada irrestrita.</p>
            ...
            <div className="relative bg-white dark:bg-[#111827] rounded-2xl border border-orange-100 dark:border-orange-900/30 p-8 shadow-sm flex flex-col">
              ...
              <div className="flex flex-col gap-6 relative z-10 flex-1">
                <div className="flex items-start gap-4">
                  ...
                  <div className="inline-flex bg-slate-50/80 dark:bg-slate-900/30 px-3 py-1.5 rounded-lg mt-1">
                    <span className="text-[13px] text-slate-700 dark:text-slate-400 font-semibold">
                      Custo de capital e ambiente corporativo postergando projetos estruturais.
                    </span>
                  </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4 text-[14px] text-slate-600 dark:text-slate-400 leading-relaxed md:pl-[64px]">
                  <p>
                A trajetória sustentada de expansão segue amplamente prejudicada pelo custo de capital. Projeções atuais da CNI e analistas de mercado traçam avanço modesto no ano, estacionado na faixa inferior de 0,6%. O ambiente corporativo de endividamento encarecido forçará a postergação de projetos longos. Mudanças de humor do empresariado sobre juros ou subsídios serão cruciais para alterar (ou agravar) a trajetória atual.
              </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-white dark:bg-[#111827] rounded-2xl border border-slate-100 dark:border-slate-900/30 p-8 shadow-sm flex flex-col ">
              ...
              <div className="flex flex-col gap-6 relative z-10 flex-1">
                <div className="flex items-start gap-4">
                  ...
                  <div className="inline-flex bg-slate-50/80 dark:bg-slate-900/30 px-3 py-1.5 rounded-lg mt-1">
                    <span className="text-[13px] text-slate-700 dark:text-slate-400 font-semibold">
                      Priorização de liquidez e paralisação de grandes projetos de expansão.
                    </span>
                  </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4 text-[14px] text-slate-600 dark:text-slate-400 leading-relaxed md:pl-[64px]">
                  <p>
                  Este cenário é dicotômico para a empresa. Representa grandes oportunidades de crescimento comercial na vertente atrelada à conservação, manutenção de equipamentos operacionais e obras essenciais rápidas de infraestrutura. No entanto, proíbe o otimismo cego e a alocação pesada de caixa próprio apostando numa euforia industrial de ampliações generalizadas. Deve-se modular agressivamente as expansões, focar na flexibilidade financeira e garantir liquidez.
                </p>
                </div>
              </div>
            </div>
          ...
          {/* Quote Section */}
          <div className="relative px-4 md:px-8 py-6 bg-cyan-50 dark:bg-cyan-900/10 rounded-2xl border border-cyan-100 dark:border-cyan-900/30">
            <Quote className="absolute top-4 left-4 w-8 h-8 text-cyan-200 dark:text-cyan-900/50 rotate-180" />
            <p className="text-[18px] md:text-[20px] text-slate-800 dark:text-slate-200 italic font-medium relative z-10 pl-8 leading-relaxed">
              "Para a empresa, o setor importa pois sinaliza a retomada de obras, reformas, expansão de capacidades e demanda estrutural por materiais de construção."
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="evidencias" className="scroll-mt-12 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 w-full">
          {INVESTIMENTOS_EVIDENCES.map((ev) => (
