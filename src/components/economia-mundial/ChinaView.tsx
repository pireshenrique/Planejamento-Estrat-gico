...
const EXPORT_COMMODITIES_SHARE = [
...
const INVESTMENT_SECTORS_DATA = [
  { setor: 'Infraestrutura & Portos', percentual: 35, valor: 'US$ 7,0 Bi', icon: Ship },
  { setor: 'Energia Limpa & Transmissão', percentual: 30, valor: 'US$ 6,0 Bi', icon: Zap },
  { setor: 'Telecom, 5G & Data Centers', percentual: 20, valor: 'US$ 4,0 Bi', icon: Server },
  { setor: 'Indústria & Eletromobilidade', percentual: 15, valor: 'US$ 3,0 Bi', icon: Cpu }
];

const STRATEGIC_VECTORS = [
  {
    id: 'transicao',
  ...
  return (
    <div className="w-full flex flex-col gap-8 pb-12 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {STRATEGIC_INDICATORS.map((ind, idx) => {
      ...
      <section className="bg-gradient-to-br from-[#0c162c] to-[#122244] rounded-3xl border border-[#1e2a4a] p-6 sm:p-8 text-white shadow-lg relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
          {EXECUTIVE_SUMMARY.bullets.map((bullet, idx) => (
            <div 
              key={idx} 
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-[#0c162c] rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
            ...
            <div className="h-[280px] sm:h-[320px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={TRADE_HISTORY_DATA} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
          ...
          <div className="lg:col-span-5 bg-white dark:bg-[#0c162c] rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      dataKey="value"
                    >
                      {EXPORT_COMMODITIES_SHARE.map((entry, index) => (
            ...
            <div className="grid grid-cols-2 gap-2 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs">
              {EXPORT_COMMODITIES_SHARE.map((item, idx) => (
        ...
        <div className="bg-white dark:bg-[#0c162c] rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {INVESTMENT_SECTORS_DATA.map((item, idx) => {
              const IconSetor = item.icon;
              return (
                <div 
                  key={idx}
